...
| Cloud (docs/deployment-runbook.md) | Render/Fly/Railway | Managed PG/MinIO | Per runbook | Deployer |
...
| Schema.md | 7-table model |
| API.md | Endpoint contracts |
| SecurityAndCompliance.md | Security architecture |
| Deployment.md | Docker + cloud runbooks |
