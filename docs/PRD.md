...
- Docker stack required for live eval (23-question run pending — see Tracker.md OQ-01).
- Known gap: `asyncpg` missing from local env blocks `backend/tests/conftest.py` import (see Tracker.md blocker R-01).
...
- [ ] Docs suite in sync (API.md, Deployment.md, Testing.md)
...
|---|---|
| TechSpec.md | Architecture and stack |
| AppFlow.md | Screens and journeys |
| Design.md | Visual system |
| Schema.md | 7-table data model |
| ImplementationPlan.md | Phases mapping REQs |
| Tracker.md | Live status incl. R-01 blocker |
| Rules.md | Standards and CI gates |
| API.md | Endpoint contracts |
| SecurityAndCompliance.md | Threat model + 8/8 red team |
| Testing.md | 77+ test strategy |
| Deployment.md | Docker stack + cloud runbooks |
