...
| Documentation | 8.5 | 9.5 | +1.0 | ../decisions/DECISIONS.md (F5/F4/F3/F6/F10/F11/G2/F18/F7/G9/G8), audit-before-after.md, architecture.md, ../technical/security-notes.md, deployment-runbook.md, case-study.md updated with 7 documented bugs |
...
| F5 | OAuth dead schema resolution | ✅ DONE | Migration 004 drops `google_id`/`github_id`; `../decisions/DECISIONS.md` documents rationale |
