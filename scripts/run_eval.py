...
from app.services.evaluation import run_single_eval, compute_metrics, faithfulness_check
from app.services.retrieval import HybridRetriever, dense_search
...
def write_report(
    ...
    lines.extend([
        ...
        "---",
        "",
        "*Report generated by Veridoc evaluation harness.*",
    ])
